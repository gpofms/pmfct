            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary_1 border_light-1 rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0 text-color-1">Add Agency Details</h6>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="">
                                        <form class="needs-validation"  action="{{ route('agency-master.store') }}" id="agency_master_form" method="post" enctype="multipart/form-data" novalidate>
                                            @csrf
                                            <div class="row">
                                                <div class="form-group col-md-4">
                                                    <label class="d-block mb-4">
                                                        <span class="form-label d-block mendatory">Agency Name *</span>
                                                        <input class="form-control" id="name" type="text" name="name" placeholder="Enter Agency Name" autocomplete="name" required>
                                                        @error('name')
