            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary_1 border_light-1 rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0 text-color-1">Edit Agency Details</h6>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="">
                                        <form class="needs-validation"  action="{{ route('agency-master.update', $agencies->id) }}" id="agency_master_form" method="post" enctype="multipart/form-data" novalidate>
                                            @csrf
                                            @method('PATCH')
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label class="d-block mb-4">
                                                        <span class="form-label d-block mendatory">Agency Name *</span>
                                                        <input class="form-control" id="agency_name" type="text" name="agency_name" placeholder="Enter Agency Name" autocomplete="agency_name" value="{{$agencies->name}}" required>
                                                        @error('agency_name')
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="active" id="active" class="radio" value="N">
