            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary_1 border_light-1 rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0 text-color-1">Add KPI Details</h6>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="">
                                        <form class="needs-validation"  action="{{ route('kpi-master.store') }}" id="kpi_master_form" method="post" enctype="multipart/form-data" novalidate>
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label class="d-block mb-4">
                                                        ...
                                                        <input class="form-control" id="kpi_name" type="text" name="kpi_name" placeholder="Enter KPI Name" autocomplete="kpi_name" required>
                                                        @error('kpi_name')
                                                            <span class="text-danger">{{$message}}</span>
                                                        @enderror
                                                      </label>
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label class="d-block mb-4">
                                                        ...
                                                        <input class="form-control" id="description" type="text" name="description" placeholder="Enter Description" autocomplete="description" required>
                                                        @error('description')
                                                            <span class="text-danger">{{$message}}</span>
                                                        @enderror
                                                      </label>
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label class="d-block mb-4">
                                                        ...
                                                        <input class="form-control" id="equation" type="text" name="equation" placeholder="Enter equation" autocomplete="equation">
                                                        @error('equation')
                                                            <span class="text-danger">{{$message}}</span>
                                                        @enderror
                                                      </label>
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $.each(result, function (key, value) {
                        selectedTxt = '';
                        if ($('#selected_ddo_id').val() == value.id)
        ...
        if(selectedAgencyId != '') {
            ...
            $.ajax({
                ...
                success: function (result) {
                    $("#event_id").html('<option value=" ">Select Events</option>');
                    $.each(result, function (key, value) {
                        $("#event_id").append('<option value="' + value.id + '">' + value.name + '</option>');
                    });
                }
            });
        }
